<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"E:\chatroom\public/../application/admin\view\index\article.html";i:1497282141;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="gb2312">
...
<header>
  ...
  <div class="topnews">
      <form id="textform" action="<?php echo url('/releasearticle'); ?>" method="post">
         	 <h2>标题:<input type="text" name="Title" /></h2>        	 
				<textarea id="demo" name="Article" value="Article"></textarea>
