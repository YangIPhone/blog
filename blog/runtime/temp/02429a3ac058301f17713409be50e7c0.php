<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\chatroom\public/../application/index\view\index\index.html";i:1497322968;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="gb2312">
...
window.onload = function ()
{
    ...
    <div class="tuwen">
      ...
      <ul>
        <?php if(is_array($new) || $new instanceof \think\Collection || $new instanceof \think\Paginator): $i = 0; $__LIST__ = $new;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <li><a href="/"><img src="<?php echo IMG_URL; ?><?php echo $v['Img']; ?>"><b><?php echo $v['Title']; ?></b></a>
...
<footer>
  <p class="ft-copyright">杨昌权个人博客</p>
</footer>
</body>
</html>
